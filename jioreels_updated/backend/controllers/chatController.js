...
exports.sendMessage = async (req, res) => {
  try {
    ...
    // Emit to the conversation room — both sender and receiver are joined to it
    req.io.to(`conv_${conv._id}`).emit('new_message', { conversationId: conv._id, message: newMsg });
